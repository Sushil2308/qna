    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(help_text='Chat Session Initiated by which User', on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chatSession', models.ForeignKey(help_text='Document Related to Which Session', on_delete=django.db.models.deletion.DO_NOTHING, to='qna.chatsessionmanager')),
                ('document', models.ForeignKey(help_text='Document Info of the given Session', on_delete=django.db.models.deletion.DO_NOTHING, to='documents.documentinfo')),
            ],
        ),
    ]
